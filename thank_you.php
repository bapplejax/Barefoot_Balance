...
<html lang="en">
    <head>
        ...
        <title>WSI Outdoor South Central USA - Thank You</title>
        <!-- Bootstrap Core CSS -->
    ...
    <body id="contact-page">
        ...
        <div class="intro-header img-responsive">
            <div class="container changeopacity" style="margin-top: 15%;">
                <div class="row row-centered">
                    <div class="col-lg-10 col-centered">                        
                        <h1>Thank You for Your Interest in WSI Outdoor!</h1>
                        <h3>A member of our team will respond to you as soon as possible.</h3>                        
                    </div>
                </div><!-- /.container -->
            </div>
        </div>
